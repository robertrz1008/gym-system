...
import { changeImage, createClientRequest, createImage, deleteClientRequest, deleteImage, getClientByFilterRequest, getClientsRequest, getImagesById, updateClientRequest } from "../controllers/clientController"
